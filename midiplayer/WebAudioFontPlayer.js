(function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
    ...
    function WebAudioFontPlayer() {
        ...
        this.queueWaveTable = function (audioContext, target, preset, when, pitch, duration, volume, slides) {
            ...
            // Use square wave for classic 8-bit sound (can also use triangle, sawtooth)
            // Different types for different instrument ranges
            if (pitch < 48) {
                oscillator.type = 'triangle'; // Bass sounds
            } else if (pitch < 72) {
                oscillator.type = 'square'; // Mid-range melody
            } else {
                oscillator.type = 'square'; // High melody
            }
            
            oscillator.frequency.setValueAtTime(frequency, startWhen);
            
            // Handle pitch slides
            if (slides) {
                if (slides.length > 0) {
                    for (var i = 0; i < slides.length; i++) {
                        var newFrequency = 440 * Math.pow(2, (slides[i].pitch - 69) / 12);
                        var newWhen = when + slides[i].when;
                        oscillator.frequency.linearRampToValueAtTime(newFrequency, newWhen);
                    }
                }
            }
            ...
            // 8-bit style envelope (quick attack, short sustain, quick release)
            var attackTime = 0.01;
            var decayTime = 0.05;
            var sustainLevel = volume * 0.7;
            var releaseTime = 0.05;
            
            gainNode.gain.setValueAtTime(0, startWhen);
            gainNode.gain.linearRampToValueAtTime(volume, startWhen + attackTime);
            gainNode.gain.linearRampToValueAtTime(sustainLevel, startWhen + attackTime + decayTime);
            gainNode.gain.setValueAtTime(sustainLevel, startWhen + duration - releaseTime);
            gainNode.gain.linearRampToValueAtTime(0, startWhen + duration);
            ...
            // Return gainNode as envelope for compatibility
            return gainNode;
        };
